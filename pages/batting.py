...
def render_batting_page():
    ...
    st.markdown(
        ...
        <div style="margin-bottom: 24px;">
            ...
            <p style="font-size: 1.05rem; color: #94A3B8; margin-top: 6px;">
                Upload your batting video and let CricFit AI analyze your posture, mobility, balance, and physical control.
            </p>
        </div>
        """,
    ...
    st.button("ANALYZE BATTING", key="btn_analyze_batting_placeholder", type="primary", use_container_width=True)
    ...
    if uploaded_file is not None:
        ...
        if st.button("ANALYZE BATTING", key="btn_analyze_batting", type="primary", use_container_width=True):
            pass
    else:
        st.markdown(
            """
            <div style="border: 2px dashed rgba(255, 255, 255, 0.15); border-radius: 20px; padding: 40px; text-align: center; background: rgba(15, 23, 42, 0.4); margin-top: 20px;">
                ...
                <p style="color: #94A3B8; font-size: 0.9rem; margin: 0;">
                    Select a high-quality video clip showing your batting stance, stride, and stroke execution.
                </p>
            </div>
            """,
            unsafe_allow_html=True
